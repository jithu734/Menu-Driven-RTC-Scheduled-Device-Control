/*==========================================================================
 * RTC SCHEDULER / DEVICE CONTROL PROJECT
 *
 * Target   : LPC21xx / LPC2129
 * Purpose  : RTC-based time display, keypad menu, device scheduling,
 *            external interrupt handling, LCD interface and Flash storage.
 *
 * NOTE: Program logic and executable statements are preserved.
 *       Only code formatting and documentation comments were improved.
 *==========================================================================*/
